...
## [Billeder af git fra i mandags](img/KasperTavle.pdf)

**[Der er en opgave nederst på siden som I skal arbejde igennem parvis eller i hele gruppen.](#opgave)**
...
### Opg 8
Slet det directory som indeholder projekter. Check at det er fuldstændigt væk, dødt, borte, pist fortabt! Dernæst gå til jeres Github og klon det så du får det igen. Pointe: Hvis det er på jeres github er det aldrig tabt!!!!
